...
fuel : (FUEL_TYPE typeOfFuel) | (FUEL_AVAILABILITY fuelAvail);
...
/* RUNWAY NODE */
runway_node : RUNWAY runway_attributes* CLOSE_TAG runway_nodes* CLOSE_RUNWAY;
...
runway_attributes: (LAT value_lat) |
				   ...
				   (RUNWAY_SECONDARY_DESIGNATOR secondary_designator) |
