...
public class CompListener extends compBaseListener{
	...
	private Markings makingsNode;
	private Lights lightsNode;
	private OffThreshold offthresholdNode;
	...
	public CompListener(){
		...
		offthresholdNode = new OffThreshold();
	...
	public void enterValue_string(compParser.Value_stringContext ctx){
		try{
			String attribute = ctx.value_string().getText();
	...
	public void enterValue_lat(compParser.Value_latContext ctx){
		try{
			String attribute = ctx.value_lat().getText();
			String value = ctx.LAT().getText();
	...
	public void enterValue_lon(compParser.Value_lonContext ctx){
		try{
			String attribute = ctx.value_lon().getText();
			String value = ctx.LON().getText();
		...
		try{
			...
			switch(attribute){
				case "alt=":
					...
					break;
				case "length=":
					runwayNode.setLenght(value);
					break;
				case "width=":
					runwayNode.setWidth(value);
					break;
				case "patternAltitude=":
					runwayNode.setPatternALT(value);
					break;
				default:
					break;
			}
	...
	public void enterValue_magvar(compParser.Value_magvarContext ctx){
		try{
			String attribute = ctx.value_magvar().getText();
			String value = ctx.MAGVAR().getText();
		...
		try{
			...
			switch(attribute){
				case "airportTestRadius=":
					airportNode.setAirportTestRadius(value);
					break;
				default:
					break;
			}
	...
	@Override
	public void void enterFuelAvail(compParser.FuelAvailContext ctx){
		try{
	...
	public void enterBoolean_value(compParser.Boolean_valueContext ctx){
		try{
			...
			switch(attribute){
				case "primaryTakeoff=":
					runwayNode.setDesignator(ctx.RUNWAY_PRIMARY_TAKEOFF.getText());
					break;
				case "primaryLanding=":
					runwayNode.setDesignator(ctx.RUNWAY_PRIMARY_LANDING.getText());
					break;
				case "secondaryTakeoff=":
					runwayNode.setDesignator(ctx.RUNWAY_SECONDARY_TAKEOFF.getText());
					break;
				case "secondaryLanding=":
					runwayNode.setDesignator(ctx.RUNWAY_SECONDARY_LANDING.getText());
					break;
				default:
					break;
			}
	...
	public void enterPattern_value(compParser.Pattern_valueContext ctx){
		try{
			...
			switch(attribute){
				case "primaryPattern=":
					runwayNode.setDesignator(ctx.RUNWAY_PRIMARY_PATTERN.getText());
					break;
				case "secondaryPattern=":
					runwayNode.setDesignator(ctx.RUNWAY_SECONDARY_PATTERN.getText());
					break;
				default:
					break;
			}
		...
		try{
			...
			switch(attribute){
				case "primaryMarkingBias=":
					runwayNode.setDesignator(ctx.RUNWAY_PRIMARY_MARKING_BIAS.getText());
					break;
				case "secondaryMarkingBias=":
					runwayNode.setDesignator(ctx.RUNWAY_SECONDARY_MARKING_BIAS.getText());
					break;
				default:
					break;
			}
		...
		try{
			...
			switch(attribute){
				...
				case "noThreshHoldEndArrows=":
					markingsNode.setNoThreshHoldEndArrows(value);
					break;
				case "edges=":
	...
	public void enterLength_attr(compParser.Length_attrContext ctx){
		try{
			...
			switch(attribute){
				case "length=":
					offthresholdNode.setLength(ctx.length_attr().getText());
					break;
				default:
					break;
			}
		...
		try{
			...
			switch(attribute){
				...
				case "touchdown=":
					...
					break;
				case "endLights=":
					approachligthsNode.setLights(value);
					break;
				default:
					break;
			}
			...
			switch(attribute_num){
				case "strobes=":
					approachligthsNode.setScrobes(value);
					break;
				default:
					break:
			}
